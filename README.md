...
## [Читать на хабр](https://habr.com/ru/articles/732454/)
### IMPORTANT:
Мы не можем бесконечно арендовывать сервера, так что не факт, что от дашборда остались только фото в репозитории github
